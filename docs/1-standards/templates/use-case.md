...
**Módulo:** [Identity-Access / Human-Resources / Notifications]
...
* **Domain Event:** [Nombre del evento interno si aplica].
* **Integration Event:** [Nombre del evento de integración publicado, si aplica].
